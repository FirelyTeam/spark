...
public class IndexService : IIndexService
{
    ...
    private void AddMetaParts(Resource resource, IKey key, IndexValue entry)
    {
        ...
        entry.Values.Add(new IndexValue(IndexFieldNames.SELFLINK, new StringValue(key.ToUriString()))); //CK TODO: This is actually Mongo-specific. Move it to Spark.Store.MongoDB, but then you will have to communicate the key to the MongoIndexMapper.
