...
public class CapabilityStatementBuilder
{
    ...
    public CapabilityStatement Build()
    {
        ...
        if (_imports is { Count: > 0 }) capabilityStatement.ImportsElement = _imports;
    ...
    public CapabilityStatementBuilder WithImplementation(Markdown description, FhirUrl url = null, ResourceReference custodian = null)
    {
