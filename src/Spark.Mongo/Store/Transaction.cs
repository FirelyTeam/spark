...
namespace Spark.Store.Mongo
{
    public class MongoTransaction
    {
        ...
        private void MarkExisting(BsonDocument document)
        {
            ...
            FilterDefinition<BsonDocument> query = Builders<BsonDocument>.Filter.And(Builders<BsonDocument>.Filter.Eq(Field.RESOURCEID, id), Builders<BsonDocument>.Filter.Eq(Field.STATE, Value.CURRENT));
            UpdateDefinition<BsonDocument> update = Builders<BsonDocument>.Update.Set(Field.TRANSACTION, transid);
        ...
        public void MarkExisting(IEnumerable<BsonDocument> documents)
        {
            ...
            UpdateDefinition<BsonDocument> update = Builders<BsonDocument>.Update.Set(Field.TRANSACTION, transid);
            FilterDefinition<BsonDocument> query = Builders<BsonDocument>.Filter.And(Builders<BsonDocument>.Filter.Eq(Field.STATE, Value.CURRENT),  Builders<BsonDocument>.Filter.In(Field.RESOURCEID, keys));
            collection.UpdateMany(query, update);
        }
        ...
        {
            FilterDefinition<BsonDocument> query = Builders<BsonDocument>.Filter.Eq(Field.TRANSACTION, transid);
            UpdateDefinition<BsonDocument> update = Builders<BsonDocument>.Update.Set(Field.TRANSACTION, 0);
            collection.UpdateMany(query, update);
        }
        ...
        {
            FilterDefinition<BsonDocument> query = Builders<BsonDocument>.Filter.And(Builders<BsonDocument>.Filter.Eq(Field.TRANSACTION, transid), Builders<BsonDocument>.Filter.Eq(Field.STATE, statusfrom));
            UpdateDefinition<BsonDocument> update = Builders<BsonDocument>.Update.Set(Field.STATE, statusto);
            collection.UpdateMany(query, update);
