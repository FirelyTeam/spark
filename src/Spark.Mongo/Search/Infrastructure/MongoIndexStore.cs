    ...
    public class MongoIndexStore : IIndexStore
    {
        ...
        public void Save(BsonDocument document)
        {
            try
            {
                ...
                FilterDefinition<BsonDocument> query = Builders<BsonDocument>.Filter.Eq(InternalField.ID, keyvalue);
        ...
        public void Delete(Entry entry)
        {
            ...
            FilterDefinition<BsonDocument> query = Builders<BsonDocument>.Filter.Eq(InternalField.ID, id);
            Collection.DeleteMany(query);
        }
