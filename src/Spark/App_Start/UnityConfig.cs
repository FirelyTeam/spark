...
namespace Spark
{
	public static class UnityConfig
	{
		...
		public static UnityContainer GetUnityContainer()
		{
			...
			container.RegisterType<IGenerator, MockIdGenerator>( new ContainerControlledLifetimeManager() );
			...
			//TODO:container.RegisterType<IServiceListener, SearchService>("searchListener");
			...
			container.RegisterType<IFhirServiceExtension, CapabilityStatementService>( "conformance" );
