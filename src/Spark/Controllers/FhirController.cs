...
namespace Spark.Controllers
{
    ...
    public class FhirController : ApiController
    {
        ...
        public async Task<FhirResponse> Read(string type, string id)
        {
            ...
            FhirResponse response = await _fhirService.Read(key, parameters);
        ...
        public async Task<FhirResponse> VRead(string type, string id, string vid)
        {
            ...
            return await _fhirService.VersionRead(key);
        }
        ...
        public async Task<FhirResponse> Update(string type, Resource resource, string id = null)
        {
            ...
            if (key.HasResourceId())
            {
                ...
                return await _fhirService.Update(key, resource);
            }
            else
            {
                return await _fhirService.ConditionalUpdate(key, resource,
        ...
        {
            var parameters = new HistoryParameters(Request);
            return await _fhirService.History(type, parameters);
        }
        ...
        {
            return await _fhirService.CapabilityStatement(Settings.Version);
        }
        ...
        {
            return await _fhirService.Transaction(bundle);
        }

        //[HttpPost, Route("Mailbox")]
        //public async Task<FhirResponse> Mailbox(Bundle document)
        //{
        ...
        {
            var parameters = new HistoryParameters(Request);
            return await _fhirService.History(parameters);
        }
        ...
        public async Task<FhirResponse> Snapshot()
        {
            ...
            int start = FhirParameterParser.ParseIntParameter(Request.GetParameter(FhirParameter.SNAPSHOT_INDEX)) ?? 0;
            return await _fhirService.GetPage(snapshot, start);
        }

        // Operations

        [HttpPost, Route("${operation}")]
        public async Task<FhirResponse> ServerOperation(string operation)
        {
        ...
        {
            Key key = Key.Create(type, id);
            return await _fhirService.Everything(key);
        }
        ...
        public async Task<FhirResponse> Document(string id)
        {
            ...
            return await _fhirService.Document(key);
        }
