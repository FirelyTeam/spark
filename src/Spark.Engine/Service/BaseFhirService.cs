...
{
    public class BaseFhirService : IFhirService
    {
        ...
        internal BaseFhirService(IBaseFhirStore fhirStore, IBaseFhirResponseFactory responseFactory, ITransfer transfer)
        {
        ...
        public FhirResponse Search(string type, SearchParams searchCommand)
        {
            ...
            Bundle bundle = new Bundle();// fhirStore.
