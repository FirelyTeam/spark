...
namespace Spark.Engine.Service.FhirServiceExtensions
{
    ...
    /// IndexPart is 
    /// </summary>
    public class IndexServiceLegacy
    {
        ...
        public IndexServiceLegacy(IFhirModel fhirModel, FhirPropertyIndex propIndex, ResourceVisitor resourceVisitor, ElementIndexer elementIndexer, IIndexStore indexStore)
        {
