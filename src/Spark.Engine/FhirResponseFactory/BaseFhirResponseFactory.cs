...
{
    public class BaseFhirResponseFactory : IBaseFhirResponseFactory
    {
        private readonly IFhirResponseInterceptorRunner interceptorRunner;
        private readonly ILocalhost localhost;

        public BaseFhirResponseFactory(ILocalhost localhost, IFhirResponseInterceptorRunner interceptorRunner)
        {
