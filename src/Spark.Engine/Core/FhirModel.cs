...
namespace Spark.Engine.Core
{
	...
	public class FhirModel : IFhirModel
	{
		...
		{
			return SearchParameters.Where( sp => sp.Base.Contains( GetResourceTypeForResourceName( resourceName ) ) || sp.Base.Contains( ResourceType.Resource ) );
		}
